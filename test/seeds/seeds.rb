...
puts "Creating Solr schema for the '_rj-rb-client-cities-delete-schema' collection."
...
puts "Creating Solr schema for the '_rj-rb-client-us-capitals' collection."
schema = RiakJson::CollectionSchema.new
